...
/*   Updated: 2023/02/19 16:25:44 by ade-orma         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

/*
*	memcmp
*	Function that compares two strings based on their ASCII values in the
*	first nBytes from zero.
*	If the values are the same for each byte, it returns 0.
*	If they are different, it returns the difference between the
*	ASCII values (str1 - str2).
*	It's important to treat everything as unsigned to avoid unequal values
*	even when the byte has the same value.
*/
